/** Simple chat bubble icon for the floating launcher. */
export const CHAT_ICON_SVG = `<svg class="li-launcher-icon-svg" viewBox="0 0 24 24" fill="none" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
