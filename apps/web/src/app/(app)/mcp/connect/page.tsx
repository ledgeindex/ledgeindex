      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            {isDesktop
              ? "Connect your MCP client to this machine’s local sidecar — personal sources on :3015."
              : "Add this server in any MCP client. Consent only appears when the client opens a connect link."}
          </p>
        </div>
      </div>
