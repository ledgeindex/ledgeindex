...
Open-core knowledge indexing for developer documentation: crawl, chunk, embed, retrieve, and chat with citations. Built on [Mastra](https://mastra.ai), Fastify, and pluggable vector storage (LibSQL locally, Postgres/pgvector in production).

**Repository:** [github.com/ledgeindex/ledgeindex](https://github.com/ledgeindex/ledgeindex)  
**npm scope:** `@ledgeindex/*`  
**License:** [Sustainable Use License](./LICENSE.md)
